/*
Exposes the raw C API as provided in mex.h, matrix.h and mat.h. The rust bindings were mostly automatically generated by bindgen and possible version suffixes removed for interoperability. Some manual changes were made to ease usage or simplify the exposed API without sacrificing functionality.
*/
...
mod bindings_700;
#[cfg(feature = "separate-complex")]
pub use bindings_700::{
    fn_clean_up_after_error, fn_mex_get_local_function_table, fn_mex_set_local_function_table,
    fn_simple_function_to_string, matClose, matDeleteVariable, matGetDir, matGetErrno, matGetFp,
    matGetNextVariable, matGetNextVariableInfo, matGetVariable, matGetVariableInfo, matOpen,
    matPutVariable, matPutVariableAsGlobal, mexAtExit, mexCallMATLABWithObject,
    mexCallMATLABWithTrapWithObject, mexErrMsgIdAndTxt, mexErrMsgTxt, mexEvalString,
    mexEvalStringWithTrap, mexFunction, mexFunctionName, mexFunctionTable, mexFunctionTableEntry,
    mexGetVariablePtr, mexGetVariableWithObject, mexGlobalTable, mexGlobalTableEntry,
    mexInitTermTableEntry, mexIsGlobal, mexIsLocked, mexLocalFunctionTable, mexLock,
    mexMakeArrayPersistent, mexMakeMemoryPersistent, mexPrintAssertion, mexPrintf, mexPutVariable,
    mexUnlock, mexWarnMsgIdAndTxt, mexWarnMsgTxt, mex_exit_fn, mxAddField, mxArray,
    mxArrayToString, mxArrayToUTF8String, mxCalcSingleSubscript_730 as mxCalcSingleSubscript,
    mxCalloc, mxChar, mxClassID, mxClassID_mxCELL_CLASS, mxClassID_mxCHAR_CLASS,
    mxClassID_mxDOUBLE_CLASS, mxClassID_mxFUNCTION_CLASS, mxClassID_mxINDEX_CLASS,
    mxClassID_mxINT16_CLASS, mxClassID_mxINT32_CLASS, mxClassID_mxINT64_CLASS,
    mxClassID_mxINT8_CLASS, mxClassID_mxLOGICAL_CLASS, mxClassID_mxOBJECT_CLASS,
    mxClassID_mxOPAQUE_CLASS, mxClassID_mxSINGLE_CLASS, mxClassID_mxSTRUCT_CLASS,
    mxClassID_mxUINT16_CLASS, mxClassID_mxUINT32_CLASS, mxClassID_mxUINT64_CLASS,
    mxClassID_mxUINT8_CLASS, mxClassID_mxUNKNOWN_CLASS, mxClassID_mxVOID_CLASS, mxComplexity,
    mxComplexity_mxCOMPLEX, mxComplexity_mxREAL, mxCreateCellArray_730 as mxCreateCellArray,
    ...
    mxGetClassName, mxGetData, mxGetDimensions_730 as mxGetDimensions, mxGetElementSize, mxGetEps,
    mxGetFieldByNumber_730 as mxGetFieldByNumber, mxGetFieldNameByNumber, mxGetFieldNumber,
    mxGetField_730 as mxGetField, mxGetImagData, mxGetInf, mxGetIr_730 as mxGetIr,
    mxGetJc_730 as mxGetJc, mxGetLogicals, mxGetM, mxGetN, mxGetNChars_730 as mxGetNChars,
    mxGetNaN, mxGetNumberOfDimensions_730 as mxGetNumberOfDimensions, mxGetNumberOfElements,
    mxGetNumberOfFields, mxGetNzmax_730 as mxGetNzmax, mxGetPi, mxGetPr, mxGetPropertyShared,
    mxGetProperty_730 as mxGetProperty, mxGetScalar, mxGetString_730 as mxGetString, mxGetUserBits,
    mxIsCell, mxIsChar, mxIsClass, mxIsComplex, mxIsDouble, mxIsEmpty, mxIsFinite,
    mxIsFromGlobalWS, mxIsFunctionHandle, mxIsInf, mxIsInt16, mxIsInt32, mxIsInt64, mxIsInt8,
    mxIsLogical, mxIsLogicalScalar, mxIsLogicalScalarTrue, mxIsNaN, mxIsNumeric, mxIsObject,
    mxIsOpaque, mxIsScalar, mxIsSingle, mxIsSparse, mxIsStruct, mxIsUint16, mxIsUint32, mxIsUint64,
    mxIsUint8, mxLogical, mxMalloc, mxRealloc, mxRemoveField, mxSetCell_730 as mxSetCell,
    mxSetClassName, mxSetData, mxSetDimensions_730 as mxSetDimensions,
    ...
    MATFile, _iobuf, matError, mxMAXNAM, MatFile_tag, _mexInitTermTableEntry,
    _mexLocalFunctionTable, mexFunctionTableEntry_tag, mexGlobalTableEntry_Tag, mxArray_tag,
    CHAR16_T, FILE,
};
...
mod bindings_800;
#[cfg(feature = "interleaved-complex")]
pub use bindings_800::{
    _iobuf, fn_clean_up_after_error, fn_mex_get_local_function_table,
    fn_mex_set_local_function_table, fn_simple_function_to_string, matClose_800 as matClose,
    ...
    mxArrayToUTF8String_800 as mxArrayToUTF8String, mxArray_tag,
    ...
    mxComplexUint32, mxComplexUint8, mxComplexity, mxComplexity_mxCOMPLEX, mxComplexity_mxREAL,
    ...
    mxCreateSparse_800 as mxCreateSparse, mxCreateStringFromNChars_800 as mxCreateStringFromNChars,
    ...
    mxFree_800 as mxFree, mxFunctionPtr, mxGetCell_800 as mxGetCell, mxGetChars_800 as mxGetChars,
    mxGetClassID_800 as mxGetClassID, mxGetClassName_800 as mxGetClassName,
    mxGetComplexDoubles_800 as mxGetComplexDoubles, mxGetComplexInt16s_800 as mxGetComplexInt16s,
    mxGetComplexInt32s_800 as mxGetComplexInt32s, mxGetComplexInt64s_800 as mxGetComplexInt64s,
    mxGetComplexInt8s_800 as mxGetComplexInt8s, mxGetComplexSingles_800 as mxGetComplexSingles,
    mxGetComplexUint16s_800 as mxGetComplexUint16s, mxGetComplexUint32s_800 as mxGetComplexUint32s,
    mxGetComplexUint64s_800 as mxGetComplexUint64s, mxGetComplexUint8s_800 as mxGetComplexUint8s,
    mxGetData_800 as mxGetData, mxGetDimensions_800 as mxGetDimensions,
    mxGetDoubles_800 as mxGetDoubles, mxGetElementSize_800 as mxGetElementSize,
    mxGetEps_800 as mxGetEps, mxGetFieldByNumber_800 as mxGetFieldByNumber,
    mxGetFieldNameByNumber_800 as mxGetFieldNameByNumber, mxGetFieldNumber_800 as mxGetFieldNumber,
    mxGetField_800 as mxGetField, mxGetInf_800 as mxGetInf, mxGetInt16s_800 as mxGetInt16s,
    mxGetInt32s_800 as mxGetInt32s, mxGetInt64s_800 as mxGetInt64s, mxGetInt8s_800 as mxGetInt8s,
    mxGetIr_800 as mxGetIr, mxGetJc_800 as mxGetJc, mxGetLogicals_800 as mxGetLogicals,
    mxGetM_800 as mxGetM, mxGetNChars_800 as mxGetNChars, mxGetN_800 as mxGetN,
    mxGetNaN_800 as mxGetNaN, mxGetNumberOfDimensions_800 as mxGetNumberOfDimensions,
    ...
    mxIsLogicalScalarTrue_800 as mxIsLogicalScalarTrue, mxIsLogicalScalar_800 as mxIsLogicalScalar,
    mxIsLogical_800 as mxIsLogical, mxIsNaN_800 as mxIsNaN, mxIsNumeric_800 as mxIsNumeric,
    mxIsObject_800 as mxIsObject, mxIsOpaque_800 as mxIsOpaque, mxIsScalar_800 as mxIsScalar,
    mxIsSingle_800 as mxIsSingle, mxIsSparse_800 as mxIsSparse, mxIsStruct_800 as mxIsStruct,
    mxIsUint16_800 as mxIsUint16, mxIsUint32_800 as mxIsUint32, mxIsUint64_800 as mxIsUint64,
    mxIsUint8_800 as mxIsUint8, mxLogical, mxMAXNAM, mxMakeArrayComplex_800 as mxMakeArrayComplex,
    mxMakeArrayReal_800 as mxMakeArrayReal, mxMalloc_800 as mxMalloc, mxRealloc_800 as mxRealloc,
    mxRemoveField_800 as mxRemoveField, mxSetCell_800 as mxSetCell,
    ...
    mxSetComplexSingles_800 as mxSetComplexSingles, mxSetComplexUint16s_800 as mxSetComplexUint16s,
    mxSetComplexUint32s_800 as mxSetComplexUint32s, mxSetComplexUint64s_800 as mxSetComplexUint64s,
    ...
    mxSetInt32s_800 as mxSetInt32s, mxSetInt64s_800 as mxSetInt64s, mxSetInt8s_800 as mxSetInt8s,
    mxSetIr_800 as mxSetIr, mxSetJc_800 as mxSetJc, mxSetM_800 as mxSetM, mxSetN_800 as mxSetN,
    ...
    mxSetUint8s_800 as mxSetUint8s, mxSetUserBits_800 as mxSetUserBits, wchar_t, MATFile,
    MatFile_tag, _mexInitTermTableEntry, _mexLocalFunctionTable, mexFunctionTableEntry_tag,
    mexGlobalTableEntry_Tag, mxComplexUint64, CHAR16_T, FILE,
};

/*
Exposes the raw C API as provided in mex.h, matrix.h and mat.h.
The rust bindings were mostly automatically generated by bindgen and reexported without version suffixes for interoperability and similarity to the usage in C.
